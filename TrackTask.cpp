...
//Dudek "D:/MATLAB files/data_seq/Dudek/img/" 1 1145 4 jpg 123 87 132 176 1
//Dudek "D:\\VS2017source\\repos\\KCFcpp\\KCFcpp\\Dudek\\img\\" 1 1145 4 jpg 123 87 132 176 1
//Dudek "D:/MATLAB files/data_seq/" 1 1145 4 jpg 123 87 132 176 1
...
string TrackTask::GetFrmPath(int frmId) const
{
	...
	char imgPath[2048];
	sprintf_s(imgPath, SeqFullPath.c_str(), frmId);
	return imgPath;
}
...
void TrackTask::PushResult(cv::Rect result)
{
	...
	if (EnableMonitor)
	{
		...
		char text[100];
		sprintf_s(text, "Frame: %d", CurrentFrmId);
